...
const Brief = () => {
  ...
  return (
    <div className="min-h-screen bg-[#121212] px-4 py-10">
      <div className="max-w-4xl mx-auto bg-[#1e1e1e] p-8 rounded-2xl shadow-lg text-white">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-semibold text-center mb-8">
          In Brief About <span className="text-green-400">{title}</span>
        </h1>

        <div className="text-base sm:text-lg leading-relaxed text-gray-300 whitespace-pre-line">
          {Array.isArray(description)
        ...
        <div className="mt-10 text-center">
          <Link
            to="/project"
            className="inline-block text-lg sm:text-xl text-gray-400 hover:text-white transition duration-200"
          >
            ⬅ Back
          </Link>
        </div>
